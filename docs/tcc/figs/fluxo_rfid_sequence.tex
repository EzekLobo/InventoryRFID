\begin{figure}[H]
\centering
\caption{Diagrama de sequ\^encia dos fluxos de eventos RFID suportados pela arquitetura}
...
\node[labelbox, draw=orange!70!black] at (8.65,-6.32) {Fluxo suportado pela API};
